...
export interface TaskServiceClient {
  ...
  listCategories(
    data: { farmId: string },
    metadata?: any,
  ): Observable<{ categories: TaskCategory[] }>;
  deleteCategory(
    data: { categoryId: string; farmId: string },
    metadata?: any,
  ...
  getTask(
    data: { taskId: string; farmId: string },
    metadata?: any,
  ): Observable<Task>;
  ...
  listTasks(
    query: any,
    metadata?: any,
  ): Observable<{ tasks: Task[]; total: number; page: number; limit: number }>;

  // Task Template CRUD
  createTaskTemplate(data: any, metadata?: any): Observable<TaskTemplate>;
  getTaskTemplate(
    data: { templateId: string; farmId: string },
    metadata?: any,
  ...
  listTaskTemplates(
    query: any,
    metadata?: any,
  ): Observable<{ templates: TaskTemplate[] }>;
}
